...
RSpec.describe "merchants invoice show page" do
  describe '#show' do
    ...
    it 'shows the discounted revenue' do
      ...
      expect(page).to have_content("Discounted Revenue: $93.75")

      visit "/merchants/#{merchant_1.id}/invoices/#{invoice_2.id}"

      expect(page).to have_content("Total Revenue: $59.50")
      expect(page).to have_content("Discounted Revenue: $52.36")
    ...
    xit 'links to bulk discount page if discount was applied' do
      merchant_1 = Merchant.create!(name: "Bobs Loggers")
